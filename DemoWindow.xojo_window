...
Begin DesktopWindow DemoWindow
   ...
   Visible         =   True
   Width           =   600
   Begin DesktopBevelButton DBBevelButton
      Active          =   False
      ...
      Bold            =   False
      ButtonStyle     =   0
      Caption         =   "Create People Database"
      CaptionAlignment=   3
      CaptionDelta    =   0
      CaptionPosition =   1
      Enabled         =   True
   ...
   Begin DesktopBevelButton BevelButton3
      ...
      Bold            =   False
      ButtonStyle     =   0
      Caption         =   "Count the number of records"
      CaptionAlignment=   3
      CaptionDelta    =   0
      CaptionPosition =   1
      Enabled         =   True
      ...
      _mPanelIndex    =   0
   End
   Begin DesktopBevelButton BevelButton4
      Active          =   False
      AllowAutoDeactivate=   True
      AllowFocus      =   True
      AllowTabStop    =   True
      ...
      Bold            =   False
      ButtonStyle     =   0
      Caption         =   "Add someone to  People Table"
      CaptionAlignment=   3
      CaptionDelta    =   0
      CaptionPosition =   1
      Enabled         =   True
   ...
   Begin DesktopTextField nameTextField
      ...
      Width           =   170
   End
   Begin DesktopTextField ageTextField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
      ...
      Width           =   45
   End
   Begin DesktopTextField emailTextField
      AllowAutoDeactivate=   True
      AllowFocusRing  =   True
      AllowSpellChecking=   False
      AllowTabs       =   False
   ...
   Begin DesktopBevelButton BevelButton2
      ...
      _mPanelIndex    =   0
   End
   Begin DesktopBevelButton BevelButton5
      Active          =   False
      AllowAutoDeactivate=   True
      AllowFocus      =   True
      AllowTabStop    =   True
      ...
      Bold            =   False
      ButtonStyle     =   0
      Caption         =   "Add email column to  People Table"
      CaptionAlignment=   3
      CaptionDelta    =   0
      CaptionPosition =   1
      Enabled         =   True
   ...
   Begin DesktopBevelButton BevelButton1
      ...
      _mPanelIndex    =   0
   End
   Begin DesktopBevelButton BevelButton6
      Active          =   False
      AllowAutoDeactivate=   True
      AllowFocus      =   True
      AllowTabStop    =   True
   ...
   Begin DesktopBevelButton BevelButton7
      ...
      Bold            =   False
      ButtonStyle     =   0
      Caption         =   "Display People Table in .CSV  format"
      CaptionAlignment=   3
      CaptionDelta    =   0
      CaptionPosition =   1
      Enabled         =   True
      ...
      _mPanelIndex    =   0
   End
   Begin DesktopBevelButton BevelButton8
      Active          =   False
      AllowAutoDeactivate=   True
      AllowFocus      =   True
      AllowTabStop    =   True
      ...
      Bold            =   False
      ButtonStyle     =   0
      Caption         =   "Display People Table in JSON  format"
      CaptionAlignment=   3
      CaptionDelta    =   0
      CaptionPosition =   1
      Enabled         =   True
   ...
   Begin DesktopTextField RecordTextField
      ...
      Width           =   46
   End
   Begin DesktopLabel RecordLabel
      AllowAutoDeactivate=   True
      Bold            =   False
      Enabled         =   True
      FontName        =   "System"
...
#tag Events DBBevelButton
	#tag Event
		Sub Pressed()
		  
		  
		  If App.Manager.CreateDatabase("People.sqlite") Then
		    MessageBox("✅ Database is ready.")
		  Else
		    MessageBox("✅ Database cannot be created")
		  End If
...
#tag Events BevelButton3
	#tag Event
		Sub Pressed()
		  ...
		  total =App.manager.CountRecords("People") 
		  MessageBox("Total records = " + total.ToString)
		  // tableName As String, data As Dictionary, whereColumn As String, whereValue As String
...
#tag Events BevelButton4
	#tag Event
		Sub Pressed()
		  ...
		  person.Value("name") = nameTextField.Text
		  person.Value("age") =ageTextField.Text
		  person.Value("eMail") = emailTextField.Text 
		  
		  If App.manager.InsertRecord("People", person)  Then
		    MessageBox(emailTextField.Text + " has been added to the people table")
		  End If
...
#tag Events BevelButton2
	#tag Event
		Sub Pressed()
		  ...
		  If App.manager.TableExists("People") Then
		    
		    MessageBox("People table already exists") 
		    
		  Else
		    
		    If App.manager.CreateTableIfNotExists("People", "ID INTEGER PRIMARY KEY, name TEXT, age INTEGER") Then
		      MessageBox("People Table created: " )
		    End If
...
#tag Events BevelButton5
	#tag Event
		Sub Pressed()
		  ...
		  If App.manager.AddColumn("People", "eMail Text") Then
		    MessageBox("eMail added as new column")
		  Else
		    MessageBox("eMail NOT added as new column")
		  End If
...
#tag Events BevelButton1
	#tag Event
		Sub Pressed()
		  ...
		  changes.Value("email") = emailTextField.Text
		  changes.Value("age") = ageTextField.Text
...
#tag Events BevelButton8
	#tag Event
		Sub Pressed()
		  ...
		  Var csv As String =App.manager.ExportTableAsJSON("People")
		  MessageBox(csv)
...
#tag Events BevelButton10
	#tag Event
		Sub Pressed()
		  ...
		  If App.manager.droptable("PEOPLE") Then
		    MessageBox("People table removed")
		  End If
